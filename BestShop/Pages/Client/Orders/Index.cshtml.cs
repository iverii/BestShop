...
{
    [RequiredAuth(RequiredRole = "client")]
    public class IndexModel : PageModel
    {
        ...
        private readonly int pageSize = 10; // orders per page

        public void OnGet()
        {
            int clinetId = HttpContext.Session.GetInt32("id") ?? 0;
            try
            {
            ...
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    {
                        command.Parameters.AddWithValue("@client_id", clinetId);
